...
personnel::personnel(int cin, QString nom, QString prenom, QString mobile, QString role, QDate date_naissance, int salaire)
{
...
bool personnel::ajouter()
{
    ...
    query.prepare("INSERT INTO personnel (cin, nom, prenom,mobile,role,date_naissance,salaire) "
                  "VALUES (:cin, :nom, :prenom, :mobile, :role, :date_naissance, :salaire)");
...
bool personnel::update(int cin, QString nom, QString prenom, QString mobile, QString role, QDate date_naissance, int salaire)
{
    QSqlQuery query;
    query.prepare("UPDATE personnel SET cin= :cin , nom= :nom , prenom= :prenom , mobile= :mobile, role= :role  , date_naissance = :date_naissance , salaire= :salaire WHERE cin = :cin");
...
void personnel::creerpdf()
{
    ...
    q.exec();
    QString pdf="<br><img src='C:/Users/LENOVO/Desktop/boutheina lagrem/logo.jpg' height='80' width='300'/> <h1  style='color:pink'>Tableau Personnels  <br></h1>\n <br> <table>  <tr>  <th>CIN </th>       <th>Nom </th>  <th>Prenom </th> <th>Mobile </th>  <th>Roles </th>  <th>Date_Naissance </th> <th>Salaire </th> </tr> " ;
...
QSqlQueryModel * personnel::cherchermobile(QString rech)
 {
     QSqlQueryModel * model= new QSqlQueryModel();
     model->setQuery("select * from personnel where upper(mobile) like upper('%"+rech+"%')");
