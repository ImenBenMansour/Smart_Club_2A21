    ...
    , ui(new Ui::MainWindow)
{
    ...
    ui->lineEdit_description->setMaxLength(10);
   ...
   ui->tableViewD->setSelectionBehavior(QAbstractItemView::SelectRows);
    ...
    ui->lineEdit_description->setStyleSheet("QLineEdit { color: red;}");
}
...
void MainWindow::on_ajouter2_clicked()
{
        ...
        role d(description,nom,nb_employes);
        bool test=d.ajouter();
...
void MainWindow::on_supprimer_role_clicked()
   ...
   int nb_employes= ui->lineEdit_nb_employes->text().toInt();
            ...
            bool test=tmprole.supprimer(description);
            role d(nom,description,nb_employes);
            if(test)
            {             ui->tableViewD->setModel(tmprole.afficher());
...
{
    {
            ...
            bool test = tmprole.update(nom,description,nb_employes);
